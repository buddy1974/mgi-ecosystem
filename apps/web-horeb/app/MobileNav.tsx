...
export default function MobileNav() {
  ...
  return (
    <>
      ...
      {menuOpen && (
        <div
          style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "#030f08", zIndex: 999, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 40 }}
          className="md:hidden"
        >
